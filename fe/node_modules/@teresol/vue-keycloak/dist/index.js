...
const useKeycloak = () => {
    return Object.assign(Object.assign({}, vue.toRefs(state)), { keycloak: getKeycloak(), hasRoles: (roles) => !isNil(roles) && state.isAuthenticated && roles.every(role => state.roles.includes(role)), hasResourceRoles: (roles, resource) => !isNil(roles) &&
            !isNil(resource) &&
